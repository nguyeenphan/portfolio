                ...
                <div className='flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200'>
                            ...
                            <div>
                                <a className='flex items-center gap-2 cursor-pointer text-white-600'
                                   href={currentProject.href} target='_blank' rel='noreferrer'>
                                    <p>Check it out</p>
                                    <img src='public/assets/arrow-up.png' className='w-3 h-3' alt='arrow'/>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div className='flex justify-between items-center mt-7'>
                        <button className='arrow-btn' onClick={() => handleNavigation('previous')}>
                            <img src='public/assets/left-arrow.png' alt='left-arrow' className='w-4 h-4'/>
                        </button>
                    ...
                    <Canvas>
                        ...
                        <Center>
                            <Suspense fallback={<CanvasLoader/>}>
                                <group scale={3} position={[-0.5, -5, 0]} rotation={[0, -0.1, 0]}>
