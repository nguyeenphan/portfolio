            ...
            <div className='grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full'>
                <div className='col-span-1 xl: row-span-3'>
                    <div className='grid-container'>
                        <img src='public/assets/Haku.png' alt='grid-1' className='w-full sm:h-[276px] h-fit object-contain rounded-xl'/>
                        <div>
                ...
                <div className='col-span-1 xl:row-span-3'>
                    <div className='grid-container'>
                        <img src='public/assets/grid-2.png' alt='grid-2' className='w-full sm:h-[276px] h-fit object-contain'/>
                        <div>
                ...
                <div className='xl:col-span-1 xl:row-span-2'>
                    <div className='grid-container'>
                        <img src='public/assets/mail.png' alt='grid-4' className='w-full sm:h-[60px] h-fit object-contain'/>
