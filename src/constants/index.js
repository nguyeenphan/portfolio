...
export const myProjects = [
    {
        ...
        texture: 'public/textures/project/project1.mp4',
        logo: 'public/assets/project-logo1.png',
        logoStyle: {
            backgroundColor: '#2A1816',
            border: '0.2px solid #36201D',
            boxShadow: '0px 0px 60px 0px #AA3C304D',
        },
        spotlight: 'public/assets/spotlight1.png',
        tags: [
            {
                id: 1,
                name: 'React.js',
    ...
    },
    {
        ...
        logo: 'public/assets/project-logo2.png',
        logoStyle: {
            backgroundColor: '#13202F',
            border: '0.2px solid #17293E',
            boxShadow: '0px 0px 60px 0px #2F6DB54D',
        },
        spotlight: 'public/assets/spotlight2.png',
        tags: [
            {
                id: 1,
                name: 'React.js',
            ...
            },
            {
                id: 2,
                name: 'TailwindCSS',
                path: 'public/assets/tailwindcss.png',
            },
        ],
    },
    // {
